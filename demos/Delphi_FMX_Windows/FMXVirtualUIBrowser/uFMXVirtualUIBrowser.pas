...
procedure CreateGlobalCEFApp;
begin
  // Start VirtualUI and allow the execution of CEF subprocesses with FMXVirtualUIBrowser_sp.exe
  VirtualUI.Start;
  VirtualUI.AllowExecute('FMXVirtualUIBrowser_sp.exe');

  GlobalCEFApp                            := TCefApplication.Create;
  GlobalCEFApp.WindowlessRenderingEnabled := True;
  GlobalCEFApp.ExternalMessagePump        := True;
  GlobalCEFApp.MultiThreadedMessageLoop   := False;
  GlobalCEFApp.BrowserSubprocessPath      := 'FMXVirtualUIBrowser_sp.exe';
...
procedure TMainForm.Panel1DialogKey(Sender: TObject;
...
procedure TMainForm.chrmosrAddressChange(Sender: TObject;
...
procedure TMainForm.SnapshotBtnEnter(Sender: TObject);
begin
  chrmosr.SetFocus(False);
end;
