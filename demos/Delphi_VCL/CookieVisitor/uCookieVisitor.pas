...
uses
  ...
  uCEFCookieManager, uCEFCookieVisitor, uCEFWinControl, uCEFChromiumCore;
...
type
  TCookieVisitorFrm = class(TForm)
    ...
    procedure Chromium1CookiesVisited(Sender: TObject; const name_, value, domain, path: ustring; secure, httponly, hasExpires: Boolean; const creation, lastAccess, expires: TDateTime; count, total, aID: Integer; same_site: TCefCookieSameSite; priority: TCefCookiePriority; var aDeleteCookie, aResult: Boolean);
...
procedure TCookieVisitorFrm.Chromium1CookiesVisited(Sender: TObject;
  ...
  total, aID: Integer; same_site: TCefCookieSameSite;
