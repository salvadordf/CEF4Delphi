...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, Vcl.ExtCtrls, System.SyncObjs, System.AnsiStrings,
  {$ELSE}
  Windows, Messages, SysUtils, Variants, Classes, Graphics,
  Controls, Forms, Dialogs, StdCtrls, ExtCtrls, SyncObjs, AnsiStrings
  {$ENDIF}
...
begin
  if (params_size > 0) then
    begin
      ...
      System.AnsiStrings.StrLCopy(PAnsiChar(TempAnsiString), PAnsiChar(params), params_size);
      AddLogLine('method: ' + method + ' -> ' + UTF8ToString(TempAnsiString));
    end;
end;
